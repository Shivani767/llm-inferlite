...
async def run_serving_simulation(config: SimulationConfig):
    """
    Run a discrete-event *queueing* simulation of serving (Poisson arrivals, concurrency limits).
    This is capacity-planning math, not an LLM benchmark. It does not measure a model.
    """
    try:
