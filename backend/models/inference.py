...
class SpeculativeDecodingProvider(InferenceProvider):
    ...
    def generate(self, prompt: str, sampling_params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        result["speculative_metrics"] = {
            "status": "unsupported",
            "reason": "Use research.experiments.speculative for measured greedy speculative decoding. This wrapper does not invent a speedup.",
            "gamma": self.gamma,
        }
        return result
...
class DistributedInferenceProvider(InferenceProvider):
    ...
    def generate(self, prompt: str, sampling_params: Dict[str, Any]) -> Dict[str, Any]:
        return {
            ...
            "status": "unsupported",
            "reason": "Distributed TP/PP is not executed. This provider does not invent scaled latency.",
